  ...
  >
    ...
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      <p className="text-base text-gray-700 mb-3 md:mb-0">
        {description || "Welcome to our restaurant, where great food meets a welcoming atmosphere. We pride ourselves on serving delicious, high-quality meals made from fresh ingredients. Whether you're here for a quick bite or a leisurely meal, our diverse menu offers something for everyone. Friendly service and a comfortable setting make us the perfect place to enjoy time with family and friends. Come experience tasty food and warm hospitality with us!"}
      </p>
